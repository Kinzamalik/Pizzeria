    ...
    return (
      <Container className="checkout-container my-3">
        <div className="checkout-type-cont">
          <button
            onClick={() => this.setState({ checkoutType: "delivery" })}
            className={`checkout-type-btn ${
              this.state.checkoutType === "delivery" && "red-active"
            }`}
          >
            Delivery
          </button>
          <button
            onClick={() => this.setState({ checkoutType: "pickup" })}
            className={`checkout-type-btn ${
              this.state.checkoutType === "pickup" && "red-active"
            }`}
          >
            Pick Up
          </button>
        ...
        <div className="checkout-type-billing">
          ...
          <div className="checkout-billing-input">
            <input
              ...
              className="checkout-billing-name"
            />
          </div>
          <div className="checkout-billing-input">
            <input
              ...
              className="checkout-billing-number"
            />
          </div>
          <div className="checkout-billing-input">
            <input
              ...
              className="checkout-billing-email"
            />
          </div>
          <div className="checkout-billing-input">
            <textarea
              ...
              className="checkout-billing-textarea"
            />
          </div>
          <div className="checkout-billing-checkbox">
            <input type="checkbox" name="" id="" />{" "}
            <span>Delivery address different from billing address</span>
          </div>
