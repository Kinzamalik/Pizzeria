    ...
    return (
      <div>
        <Navbar
          ...
          style={{ background: "#2D2D2D !important" }}
        ...
        >
          <div className="container">
            ...
            >
              {this.props.titleText} <br />{" "}
              <span style={{ fontSize: "8px" }}>{this.state.geolocation}</span>{" "}
            </h2>
        ...
        {this.props.showSearch && (
          <div
            className="searchbar"
            style={{ width: this.state.searchActive ? "90%" : "fit-content" }}
          >
            <span
